...
export const CCNavbar: React.FC = () => {
  ...
  return (
    <nav className="navbar-cc">
      <div className="display-header-right-cc">
        <NavLink
          onClick={handleClick}
          to="/"
          target="_blank"
          className="text-powered-cc"
        >
          <h5 className="align-cc-header">powered by - <span className="align-cc-wenex">wenexcorp</span></h5>
        </NavLink>
      </div>
      <div className="nav-container-cc">
        <NavLink to="/campus-connect" className="nav-logo-cc">
          <img style={{ width: '200px' }} src="/images/campusconnect/cc-logo-dark.png" alt="wenexLogo" />
        </NavLink>
