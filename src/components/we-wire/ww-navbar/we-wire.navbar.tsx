...
export const WWNavbar: React.FC = () => {
  ...
  return (
    <nav className="navbar-ww">
      <div className="display-header-right-ww">
        <NavLink
          onClick={handleClick}
          to="/"
          target="_blank"
          className="text-powered-ww"
        >
          <h5 className="align-ww-header">powered by - <span className="align-ww-wenex">wenexcorp</span></h5>
        </NavLink>
      </div>
      <div className="nav-container-ww">
        <NavLink to="/home" className="nav-logo-ww">
          <img style={{ width: '180px' }} src="/images/wewire/we-wire-logo-dark.png" alt="wenexLogo" />
        </NavLink>
