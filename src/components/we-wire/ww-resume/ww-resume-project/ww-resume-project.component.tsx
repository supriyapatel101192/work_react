...
import './ww-resume-project.scss';

import 'react-datepicker/dist/react-datepicker.css';

export const WWResumeProject: React.FC = () => {
        ...
        <Col lg="9" md="9" xs="12">
          <Form className="mx-3" onSubmit={handleRegister}>
            <Row>
              ...
              <Col lg="12">
                <div className="pt-4">
                  <h6 className="ww-resume-labels">IN WHICH <strong>ORGANIZATION</strong> DID YOU DO YOUR PROJECT?
                  </h6>
                  <Input
              ...
              <Col lg="12">
                <div className="pt-4">
                  <h6 className="ww-resume-labels"><strong>WHEN</strong> DID YOU DO YOUR PROJECT?</h6>
                  <Row>
                    <Col lg="6">
                      <DatePicker
                        ...
                        todayButton="Today"
                        className="ww-resume-proj-range-date"
                      />
                    </Col>
                    <Col lg="6">
                      <DatePicker
              ...
              <Col lg="12">
                <div className="pt-4">
                  <h6 className="ww-resume-labels">NOW DESCRIBE WHAT <strong> YOU DID</strong></h6>
                  <Input
